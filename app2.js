...
function initMap() {
    ...
    map.data.setStyle(function(feature) {
      ...
      if(feature.getProperty('FACNAME')) {
        iconStyle = {
          icon: {
      ...
      } else if (feature.getProperty('Name')) {
        iconStyle = {
          icon: {
...
angular.module('clcApp', ['ngMap', 'ngAnimate'])
  .controller('lolCtrl', function($scope, NgMap) {
    ...
    NgMap.getMap().then(function(map) {
      ...
      map.data.loadGeoJson('http://geohub.lacity.org/datasets/44546f03b92549e6b34574d9152af0fa_4.geojson');
      map.data.setStyle(function(feature) {
        return {
          icon: {
              url:'assets/img/icons/childhood.png'
      ...
      if($scope.icon == "car") {
        map.data.loadGeoJson('http://geohub.lacity.org/datasets/230abc621b144dbc96cca83d65bd454d_0.geojson');
        map.data.setStyle(function(feature) {
          return {
            fillColor: '#84C44A',
            strokeColor: '#84C44A',
